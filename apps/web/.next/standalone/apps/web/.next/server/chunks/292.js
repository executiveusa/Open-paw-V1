exports.id=292,exports.ids=[292],exports.modules={2646:(a,b,c)=>{Promise.resolve().then(c.bind(c,24414)),Promise.resolve().then(c.t.bind(c,96730,23))},16442:(a,b,c)=>{"use strict";c.d(b,{N7:()=>f,zX:()=>e});let d=[{slug:"why-animal-welfare-software-should-be-local-first",title:"Why Animal Welfare Software Should Be Local-First",category:"Technology",date:"Jan 15, 2025",description:"Shelter and rescue teams work in places with spotty internet, manage sensitive records, and operate on zero budget for cloud subscriptions. Local-first software is the only architecture that respects those constraints.",content:`Most animal welfare software is designed like enterprise SaaS. You pay a monthly fee, your data lives on someone else's server, and if you lose internet access — or the vendor raises prices — you're stuck.
...
Open Paw does it anyway, because the alternative — telling a rescue team they lost their animal records because the vendor went out of business — is not acceptable.`},{slug:"funding-radar-finding-grants-without-losing-the-plot",title:"The Open Paw Funding Radar: Finding Grants Without Losing the Plot",category:"Funding",date:"Jan 22, 2025",description:"Grant research is slow, deadline-driven, and easy to drop when you're also managing 40 animals. Funding Radar is built to make it survivable.",content:`Most animal welfare organizations are leaving grant money unclaimed — not because they don't qualify, but because grant research takes time nobody has.
...
If that's you, Funding Radar is built for you.`},{slug:"track-foster-capacity-without-spreadsheet-explosion",title:"How to Track Foster Capacity Without a Spreadsheet Explosion",category:"Operations",date:"Jan 29, 2025",description:"Foster networks live and die by capacity tracking. Here's how to do it without a 47-tab spreadsheet that only one person understands.",content:`Every rescue coordinator has a spreadsheet. Usually it's called something like "Foster Master v7 FINAL (2).xlsx" and it has seventeen tabs, color-coding that made sense six months ago, and formulas that break when someone types in the wrong column.
...
The goal isn't software for its own sake. The goal is knowing, at any moment, exactly which animals need fosters and exactly who can take them.`},{slug:"vaccine-reminder-workflow-for-rescue-teams",title:"A Simple Vaccine Reminder Workflow for Rescue Teams",category:"Medical",date:"Feb 5, 2025",description:"Missed vaccines are one of the most common preventable issues in rescue operations. Here's a workflow that makes them hard to miss.",content:`Vaccine tracking in a rescue context is harder than it looks. Animals come in with unknown histories. Vaccines happen at intake, then again at intervals. Foster families can't always make it to a vet appointment. Reminders fall through the cracks.
...
That time compounds. The coordinator who spends 20 minutes less on record-hunting every day has 80 more minutes per week for animal care.`},{slug:"how-to-write-better-adoption-bios-with-ai-and-human-review",title:"How to Write Better Adoption Bios With AI and Human Review",category:"Adoptions",date:"Feb 12, 2025",description:"A good adoption bio gets animals adopted faster. AI can help write the first draft. Here's how to use it without losing your voice or accuracy.",content:`The hardest part of an adoption bio isn't describing the animal — it's finding the energy to write yet another one after a long intake shift.
...
That's the outcome that matters.`},{slug:"what-small-rescues-need-from-software-before-they-need-ai",title:"What Small Rescues Need From Software Before They Need AI",category:"Operations",date:"Feb 19, 2025",description:"AI features are exciting. But most small rescues would benefit more from reliable record-keeping and a simple task system first.",content:`There's a lot of excitement about AI in animal welfare software. Grant drafting. Adoption bio generation. Medical record analysis.
...
Then, when your data is real and reliable, add the AI layer. It will actually work.`},{slug:"open-source-for-shelters-what-data-portability-actually-means",title:"Open Source for Shelters: What Data Portability Actually Means",category:"Technology",date:"Feb 26, 2025",description:"Data portability is often promised and rarely delivered. Here's what it actually means and why it matters for animal welfare organizations.",content:`Almost every animal welfare software vendor claims their product supports "data portability." The claim is usually true in a narrow technical sense and useless in practice.
...
When your needs outgrow Open Paw, or when you want to switch to another system, you should be able to export everything and import it elsewhere. That's the bar we're building to.`},{slug:"lost-and-found-workflows-that-help-reunite-pets-faster",title:"Lost and Found Workflows That Help Reunite Pets Faster",category:"Operations",date:"Mar 5, 2025",description:"The best reunifications happen within 24 hours. After that, chances drop sharply. Here's how to build a workflow that works fast.",content:`Most reunifications happen in the first 24-48 hours after a pet goes missing. After that, the chances of finding an owner drop significantly. This means the speed of your lost and found workflow directly determines outcomes.
...
Most organizations that move from ad-hoc reporting to a structured workflow see their reunification rate improve. The workflow doesn't find lost pets — the community does — but the workflow makes sure nothing falls through the cracks.`},{slug:"how-fiscal-sponsors-can-support-animal-welfare-programs",title:"How Fiscal Sponsors Can Support Animal Welfare Programs With Shared Tools",category:"Operations",date:"Mar 12, 2025",description:"Fiscal sponsorship is a growing model for animal welfare. Here's how shared software infrastructure can reduce overhead for both sponsors and sponsored programs.",content:`Fiscal sponsorship is a model where an established nonprofit acts as the legal and financial umbrella for a program that doesn't have its own 501(c)(3) status. For animal welfare, this is increasingly common — a new rescue group operates under a larger organization's tax exemption while building toward independent status.
...
For fiscal sponsors exploring this model, the practical starting point is: identify your highest-need sponsored programs, pilot the shared infrastructure with one or two, and expand from there. The goal is not to mandate tooling — it's to offer it as a service that reduces friction for everyone.`},{slug:"felipe-reviews-your-intake-workflow",title:"Felipe Reviews Your Intake Workflow",category:"Operations",date:"Mar 19, 2025",description:"A fictional rescue coordinator reviews common intake workflow mistakes and what to do instead.",content:`*Felipe has been coordinating animal intake at a mid-size rescue for six years. He has seen every intake workflow mistake at least twice. Here are his notes.*
...
Start with the minimum: animal record, status, location, task for next action. Get that right. Everything else comes later.`}];function e(){return d}function f(a){return d.find(b=>b.slug===a)}},62894:(a,b,c)=>{Promise.resolve().then(c.bind(c,23116)),Promise.resolve().then(c.t.bind(c,64900,23))}};